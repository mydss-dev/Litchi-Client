...
As of the creation of this target:

- brand red/pink palette: implemented
- dark navy-black palette: implemented
- shared spacing/motion/breakpoints: implemented
- connection orb: in progress
- hero row 56/44 and 228px: in progress
- realtime three-column card: in progress
- traffic progress card: in progress
- mascot: deferred
- shell 200px / 900×700 target: deferred to shell-only phase
- CI: must be green before visual work continues
