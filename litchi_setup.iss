...
WizardStyle=modern
; TUN mode needs admin privileges to install/use drivers.
...
[Files]
; Whole release directory, including sing-box.exe / wintun.dll / Flutter DLLs / data/.
...
[UninstallRun]
; Force-close the app before uninstalling.
