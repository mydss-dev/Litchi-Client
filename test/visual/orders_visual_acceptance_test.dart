...
void main() {
  ...
  testWidgets(
    'Windows 900x700 orders light visual',
    (tester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.windows;
      try {
        await pumpOrders(tester, themeMode: ThemeMode.light);
        await expectLater(
          find.byType(Scaffold),
          matchesGoldenFile('goldens/orders_light_main_900x700.png'),
        );
      } finally {
  ...
  testWidgets(
    'Windows 900x700 orders dark visual',
    (tester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.windows;
      try {
        ...
        await expectLater(
          find.byType(Scaffold),
          matchesGoldenFile('goldens/orders_dark_main_900x700.png'),
        );
      } finally {
        debugDefaultTargetPlatformOverride = null;
      }
...
const _orders = <RemoteOrder>[
  ...
  RemoteOrder(
    tradeNo: '2026090800001732',
    planName: 'Litchi Data Pack · 188G',
