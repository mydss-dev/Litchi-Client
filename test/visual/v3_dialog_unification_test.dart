...
void main() {
  for (final size in [const Size(900, 700), const Size(360, 480)]) {
    for (final dark in [false, true]) {
      testWidgets(
        'dialog keeps its shared shape and scrollable action at $size dark=$dark',
        (tester) async {
                      ...
                      builder: (_) => V3DialogFrame(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            FilledButton(
                              key: const ValueKey('dialog-submit'),
          ...
          expect(
            shape.borderRadius,
            BorderRadius.circular(V3Layout.cardRadius),
          );
