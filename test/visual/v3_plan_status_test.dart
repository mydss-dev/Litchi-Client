...
void main() {
  for (final page in [AppPage.dashboard, AppPage.shop, AppPage.account]) {
    for (final active in [true, false]) {
      testWidgets('Unnamed plan on $page uses subscription state $active', (tester) async {
        ...
        try {
          ...
          if (active) {
            // The shop now combines the plan label and remaining quota into
            // one readable line, so counting exact Text widgets is brittle.
