    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        V3PageHeader(
          ...
          title: v3Copy(context, zh: '节点概览',
            en: 'Node overview', tw: '節點概覽'),
        ),
...
class _OverviewNodeRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final statusColor = node.latency >= 9999 ? p.dangerInk
      : node.latency > 0 ? p.successInk : p.inkMuted;
    ...
    return V3Panel(padding: const EdgeInsets.symmetric(
      ...
      child: Row(children: [
        ...
        if (current) ...[
          Text(v3Copy(context, zh: '当前', en: 'Current', tw: '目前'),
